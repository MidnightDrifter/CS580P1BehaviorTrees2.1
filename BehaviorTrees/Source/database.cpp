...
/* agent communication BEGIN (by ABLA, Abdel Rahman) */
void Database::SendMsgDelayed(float delay, MSG_Name name, objectID receiver, std::string node_name, MSG_Data& data)
{
	g_msgroute.SendMsg(delay, name, receiver, SYSTEM_OBJECT_ID, node_name, data, false, false);
}
/* agent communication END */
